...
metadata :: Metadata
metadata = Metadata brown darkGray ["data/e"]
    [fossil "BRA" "Bradgatia" pink ""
    ,fossil "CHAR" "Charniid" purple ""
    ,fossil "LOB" "Lobate Discs" lightBlue ""
    ,fossil "IVE" "Ivesheadiamorphs" green ""
    ,fossil "FRA" "Fractofusus" darkBlue ""
...
brown = colorD 0.39 0.29 0.00
darkGray = colorD 0.20 0.20 0.20
pink = colorD 0.95 0.34 0.80
purple = colorD 0.59 0.24 0.72
lightBlue = colorD 0.38 0.50 0.89
green = colorD 0.21 0.62 0.17
darkBlue = colorD 0.09 0.21 0.62
